 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
    <a class="nav-link" href="{{route('registers.newCustomer')}}">
        <i class="fas fa-fw fa-chart-area"></i>
        <span>Umugenzi mushya</span></a>
    </li>
    ...
    <li class="nav-item">
    <a class="nav-link" href="{{route('registers.customers')}}">
        <i class="fas fa-fw fa-chart-area"></i>
        <span>Abagenzi</span></a>
    </li>
